...
* [Sharness itself](https://github.com/chriscool/sharness/blob/master/test)
...
* Web: <http://chriscool.github.com/sharness>
* Mail: <christian.couder@gmail.com>
* Twitter: [@ChristianCouder](https://twitter.com/ChristianCouder)
